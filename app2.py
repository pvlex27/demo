    ...
    if is_logged_in():
        ...
        for queries in sorted_grouped_queries.values():
            for query in queries:
                query['question_short'] = query['question'][:20]  # Extract first 100 characters of question
                query['answer_short'] = query['response'][0][:10]  # Extract first 200 characters of answer
  
        return render_template('dashboard2.html', username=username, grouped_queries=sorted_grouped_queries)
